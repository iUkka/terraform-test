...
variable "vsphere_dns_servers" {
  description = "What are the DNS servers of the VM (default: 192.168.100.7)"
  default     = "192.168.100.7"
}

variable "vsphere_domain" {
  description = "What is the domain of the VM"
  default = "cironline.ru"
}

variable "vsphere_time_zone" {
  description = "What is the timezone of the VM (default: Europe/Moscow)"
